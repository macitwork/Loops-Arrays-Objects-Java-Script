...
//
// ==========================================
//JavaScript switch statement te gebruiken om de neighborhood property in te vullen op basis van de postcode.
//   Het switch statement zal de postcode als input nemen en de bijbehorende buurtnaam toewijzen aan de neighborhood property.
const students = [
    {name: 'Mariska', city: 'Utrecht', zipCode: '3513', neighborhood: null},
    {name: 'Mehmet', city: 'Utrecht', zipCode: '3514', neighborhood: null},
    {name: 'Dennis', city: 'Utrecht', zipCode: '3572', neighborhood: null},
...
students.forEach(student => {
    switch (student.zipCode) {
        ...
        case '3531':
            ...
            break;
        case '3572':
            student.neighborhood = 'Wittevrouwen';
            break;
        case '3581':
